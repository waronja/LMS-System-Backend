...
school2 = School.create(name:"School of Data science", description:"Be a data analyst", school_owner_id:school_owner1.id)
...
course1= Course.create(name: "Computer Science", school_id:school1.id, student_id:student1.id, educator_id:educator1.id)
